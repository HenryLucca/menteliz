...
export default function Header() {
  const { scrolled } = useHasScrolled({ offsetThreshold: 600 });
  ...
  const headerClassesAfterScroll =
    "sticky w-full top-0 z-[9999] bg-white min-h-16 p-4 flex flex-col gap-4 md:flex-row justify-between md:items-center text-zinc-900";
